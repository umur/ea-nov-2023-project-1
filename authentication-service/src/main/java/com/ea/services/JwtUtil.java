...
public class JwtUtil {
    ...
    public String generateToken(UserVO userDetails, String tokenType) {
        return generateToken(new HashMap<>(), userDetails, tokenType);
    }

    public String generateToken(Map<String, Object> extraClaims, UserVO userDetails, String tokenType) {
        extraClaims.put("role",userDetails.getRole());
        return doGenerateToken(extraClaims, userDetails.getEmail(), tokenType);
    }
