...
public class EducationDetailsServiceImpl implements EducationDetailsService {
    ...
    private final AttendantRepository educationDetailsRepository;
    ...
    public void create(EducationDetailsDto educationDetailsDto) {
        ...
        educationDetailsRepository.save(converter.convert(educationDetailsDto, Attendant.class));
    }
    ...
    public EducationDetailsDto update(EducationDetailsDto educationDetailsDto, Long id) {
        return Optional.ofNullable(educationDetailsDto.getId()).map(entityId -> {
           ...
           return converter.convert(educationDetailsRepository.save(converter.convert(educationDetailsDto, Attendant.class)), EducationDetailsDto.class);
